                        ...
                        <div class="popular-widget-box">
                            ...
                            <div class="single-popular-item d-flex flex-wrap align-items-center">
                                ...
                                <div class="popular-item-content">
                                    ...
                                    <h5 class="title"><a href="{{route('blog.details',[$post->id, @$post->slug])}}">{{ $post->name->language->$lang->name ?? $post->name->language->$system_default->name }}</a></h5>
                                </div>
                            </div>
                            @endforeach
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 mb-30">
                        <div class="blog-item">
                            <div class="blog-thumb">
                                ...
                                <span class="category">{{ $blog->name->language->$lang->name ?? $blog->name->language->$system_default->name }}</span>
                            </div>
