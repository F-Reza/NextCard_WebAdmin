            ...
            <div class="col-xl-6 col-lg-6 mb-30">
                <div class="about-content-wrapper">
                    <div class="about-content-header">
                        <span class="text--base">{{ __($about_sections->value->language->$lang->section_title ?? $about_sections->value->language->$system_default->section_title) }}</span>
                        <h2 class="title pt-3">{{ __($about_sections->value->language->$lang->heading ?? $about_sections->value->language->$system_default->heading) }}</h2>
                        <p>{{ __($about_sections->value->language->$lang->sub_heading ?? $about_sections->value->language->$system_default->sub_heading) }}</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="item d-flex">
                                        ...
                                        <div class="item-name">
                                            <P>{{ __($item->language->$lang->title ?? $item->language->$system_default->title)}}</P>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
