        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="customer-says">
                  <h2 class="title">{{ __($testimonial->value->language->$lang->title ?? $testimonial->value->language->$system_default->title) }}</h2>
                                    ...
                                    <div class="testimonial-ratings">
                                     ...
                                     <div class="client-details d-flex justify-content-between">
                                         ...
                                         <div class="client-title text--base">
                                             <h4 class="title text--base">{{ __($item->language->$lang->name ?? $item->language->$system_default->name )}}</h4>
