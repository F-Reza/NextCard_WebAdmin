        ...
        <div class="row justify-content-center mb-30-none">
            <div class="col-xl-8 col-lg-8 mb-30">
                <div class="contact-form-area">
                    <div class="contact-header">
                        <span class="sub-title">{{ __($contact_sections->value->language->$lang->title ?? $contact_sections->value->language->$system_default->title) }}</span>
                        <h2 class="title">{{ __($contact_sections->value->language->$lang->heading ?? $contact_sections->value->language->$system_default->heading) }}</h2>
                    </div>
            ...
            <div class="col-xl-4 col-lg-4 mb-30">
                <div class="contact-information">
                    ...
                    <p>{{ __($contact_sections->value->language->$lang->infomation ?? $contact_sections->value->language->$system_default->infomation) }}</p>
                </div>
                <div class="contact-widget-box d-flex mt-3">
                    ...
                    <div class="contact-containt">
                        ...
                        {{ __($contact_sections->value->language->$lang->phone ?? $contact_sections->value->language->$system_default->phone) }}
                    </div>
                </div>
                <div class="contact-widget-box d-flex mt-3">
                    <div class="contact-icon">
                    ...
                    <div class="contact-containt">
                        ...
                        {{ __($contact_sections->value->language->$lang->address ?? $contact_sections->value->language->$system_default->address) }}
                    </div>
                </div>
                <div class="contact-widget-box d-flex mt-3">
                    <div class="contact-icon">
                    ...
                    <div class="contact-containt">
                        ...
                        {{ __($contact_sections->value->language->$lang->email ?? $contact_sections->value->language->$system_default->email) }}
                    </div>
                </div>
            </div>
        </div>
