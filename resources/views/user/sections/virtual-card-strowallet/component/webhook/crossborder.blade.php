    ...
    <div class="dashboard-list-item-wrapper">
        <div class="dashboard-list-item sent">
            ...
            <div class="dashboard-list-right">
                <h4 class="main-money text--base">{{ get_amount($item->data->amount ?? 0,$item->card_currency,2) }}</h4>
            </div>
        </div>
        <div class="preview-list-wrapper">
            ...
            <div class="preview-list-item">
                <div class="preview-list-left">
                    <div class="preview-list-user-wrapper">
                        ...
                        <div class="preview-list-user-content">
                            <span>{{ __("Charged Amount") }}</span>
                        </div>
                    </div>
                </div>
                <div class="preview-list-right">
                    <span>{{ get_amount($item->data->chargedAmount ?? 0,$item->card_currency,2) }}</span>
                </div>
            </div>
            <div class="preview-list-item">
                <div class="preview-list-left">
            ...
            <div class="preview-list-item">
                ...
                <div class="preview-list-right">
                    <span>{{ \Carbon\Carbon::parse($item->data->createdAt)->format('d-m-y h:i:s A') }}</span>
                </div>
            </div>
        </div>
    </div>
